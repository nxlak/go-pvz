	...
	default:
		...
		case '/': // Prefix: "/api/v1/order/"
			...
			if len(elem) == 0 {
				...
				switch r.Method {
				case "DELETE":
					s.handleReturnOrderRequest([1]string{
						args[0],
					}, elemIsEscaped, w, r)
				case "GET":
	...
	default:
		...
		case '/': // Prefix: "/api/v1/order/"
			...
			if len(elem) == 0 {
				...
				switch method {
				case "DELETE":
					r.name = ReturnOrderOperation
					r.summary = "Return (delete) order by id"
					r.operationID = "ReturnOrder"
					r.operationGroup = ""
				...
				case "PATCH":
					...
					return r, true
				case "PUT":
					r.name = AcceptOrderOperation
					r.summary = "Accept order"
					r.operationID = "AcceptOrder"
					r.operationGroup = ""
					r.pathPattern = "/api/v1/order/{id}"
					r.args = args
					r.count = 1
